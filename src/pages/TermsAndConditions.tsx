  ...
  return (
    <div className="p-5">
      ...
      <p>
        ...
        conditions. Do not continue to use PortokaLive if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing PortokaLive, you agreed to
        use cookies in agreement with the PortokaLive's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, PortokaLive and/or its licensors own the
        intellectual property rights for all material on PortokaLive. All
        intellectual property rights are reserved. You may access this from
        PortokaLive for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from PortokaLive</li>
        <li>Sell, rent or sub-license material from PortokaLive</li>
        <li>Reproduce, duplicate or copy material from PortokaLive</li>
        <li>Redistribute content from PortokaLive</li>
      </ul>
      ...
      <p>
        ...
        PortokaLive does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of PortokaLive,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, PortokaLive shall not be
      ...
      <p>
        PortokaLive reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant PortokaLive a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of PortokaLive; and (d) the link
      ...
      <p>
        ...
        e-mail to PortokaLive. Please include your name, your organization name,
      ...
      <p>
        No use of PortokaLive's logo or other artwork will be allowed for
