...
export const PrivacyPolicy = () => {
  return (
    <div className="p-5">
      ...
      <p>
        Kevin Moe Myint Myat built the PortokaLive app as a Free app. This
        SERVICE is provided by Kevin Moe Myint Myat at no cost and is intended
        for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at PortokaLive unless
      ...
      <p>
        ...
        but not limited to Email, Live Stream ID, Live Audio, Live Video. The
      ...
      <p>This policy is effective as of 2021-07-10</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at portoka.live@gmail.com.
      </p>{" "}
      <p>
